...
\begin{frame}[fragile]
  \frametitle{Выводы}
 \begin{itemize}
  \item Анализ графов с использованием формальных языков в качестве ограничений на пути --- активно развивающаяся область, имеющая прикладное значение
  \item Междисциплинарная область: теория графов, теория формальных языков, линейная алгебра, статический анализ кода, графовые базы данных, параллельные вычисления
  \vfill
  \pause
  \item[\faExclamation] Разрозненные исследования
  \begin{itemize}
    \item Отсутствие системности, взаимосвязей ...
    \begin{itemize}
      \item Вручную распараллеливать, писать свою линейную алгебру
      \item Анализ различных сценариев !!!!
    \end{itemize}
    \item Терминология
    \item Решения
    \item Сравнение
  ...
  \begin{itemize}
    \item Обоснование теоретических свойств
    \item Производительность прикладных решений
  \end{itemize}
  \pause
  \item[\faExclamation] Проблемы с подготовкой специалистов
  \begin{itemize}
...
\begin{frame}[fragile]
  ...
  Целью данной работы является создание общей методологии \underline{анализа графов} с использованием \underline{формальных языков} в качестве \underline{ограничений на пути}
  \begin{itemize}
...
\begin{frame}[fragile]
  ...
  \begin{enumerate}
    \item Прикладная направленность: основной фокус на алгоритмах
    \item Частные/крайние случаи (деревья, ...)
    \item Учёт особенностей прикладных областей: ide или offline, OLAP или OLTP, ....
    \item Удобство для пользователя: API, как задавать ограничения и встраивать в язык запросов, ....
  \end{enumerate}
\end{frame}
