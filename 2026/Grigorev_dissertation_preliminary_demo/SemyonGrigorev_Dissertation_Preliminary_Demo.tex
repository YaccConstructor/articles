...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item Нацеленной на получение практически значимых результатов
    \item Предоставляющей гибкий подход к решению задач
    \item Позволяющей формально рассуждать о свойствах объектов (модели, алгоритмы)
  \end{itemize}
