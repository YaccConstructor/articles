...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item Позволяющую формально рассуждать о свойствах объектов
  \end{itemize}
...
\begin{frame}[fragile]
  ...
  \begin{enumerate}[<+->]
    ...
    \item Разработаны методики конструирования алгоритмов решения FLPQ
    \begin{itemize} 
...
\begin{frame}[fragile]
  ...
  \onslide<2->{
    \begin{minipage}{0.49\textwidth}
        \includegraphics[width=0.95\textwidth]{pictures/Methodology_only.pdf}
    \end{minipage}
    \begin{minipage}{0.49\textwidth}
        \begin{itemize}
...
\begin{frame}[fragile]
  ...
  \begin{center}
    \begin{overprint}
      \only<1>{\includegraphics[width=0.5\textwidth]{pictures/Methodology_only.pdf}}
      \only<2>{\includegraphics[width=\textwidth]{pictures/Methodology_full.pdf}}
      \only<3>{\includegraphics[width=\textwidth]{pictures/Methodology_full.pdf}}
      \only<4>{\includegraphics[width=\textwidth]{pictures/Methodology_full.pdf}}
    \end{overprint}
  \end{center}
\end{frame}
