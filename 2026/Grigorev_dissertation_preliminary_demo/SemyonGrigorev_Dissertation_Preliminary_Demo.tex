...
\begin{frame}[fragile]
  ...
  \begin{center}
    \begin{overprint}
      \only<1>{\includegraphics[width=\textwidth]{pictures/Methodology_full.pdf}}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \begin{itemize}
        \item От языка запросов (Cypher) до алгоритма выполнения в инфрастуктуре БД
        \item На основе RedisGraph
      \end{itemize}
      \item Neo4j
    \end{itemize}
    \pause
