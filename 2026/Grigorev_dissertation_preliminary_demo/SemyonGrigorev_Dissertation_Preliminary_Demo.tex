...
\begin{frame}[fragile]
  \begin{center}
    \begin{overprint}
      ...
      \only<3>{\includegraphics[width=\textwidth]{pictures/Methodology_2.pdf}}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item Проверка эквивалентность конечных автоматов в общем случае \textbf{разрешима}
      \item Проверка эквивалентность КС грамматик в общем случае \textbf{неразрешима}
      \item Проверка эквивалентность MCFG в общем случае \textbf{неразрешима}
    \end{itemize}
  \end{itemize}
\end{frame}
