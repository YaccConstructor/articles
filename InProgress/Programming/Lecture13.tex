...
\verb|dotnet paket config add-token https://nuget.pkg.github.com/kirillgarbar/index.json <token>|

Токен можно получить: \url{https://github.com/settings/tokens/536207235}

Далее, добавляем https://nuget.pkg.github.com/kirillgarbar/index.json как источник пакетов (например в paket.dependencies)