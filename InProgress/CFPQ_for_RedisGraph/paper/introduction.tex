...
In this work we show that CFPQ in relational semantics (according to Hellings~\cite{hellingsRelational}) can be fast enough to be applicable to real-world graph analysis.
