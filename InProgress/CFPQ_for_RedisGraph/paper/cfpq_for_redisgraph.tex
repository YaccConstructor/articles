...
\documentclass[sigconf,edbt,table]{acmart-edbt2020}
...
\keywords{Context-free path querying, transitive closure, graph databases, linear algebra, context-free grammar, GPGPU, CUDA, boolean matrix, matrix multiplication}
