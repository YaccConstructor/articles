...
We use standard violin plot with median to show distribution of results.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{data/raw/core_4.pdf}
\caption{Performance of \textit{core} graph querying with small chunks}
\end{figure}
