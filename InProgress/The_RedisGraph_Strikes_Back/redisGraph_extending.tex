...
\Function{EvalMul}{$e_l:AlgExp, e_r:AlgExp$}
\State $M_l =$ \Call{Eval}{$e_l$}
\If {$r~is~Ref(ref)$}
    \State $ctx[ref].src \gets ctx[ref].src~+$ \Call{getDst}{$M_l$}
\EndIf
