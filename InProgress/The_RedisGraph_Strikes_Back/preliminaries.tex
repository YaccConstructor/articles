...
\simpleton{$\pi=2:\{x\}\xrightarrow{\{c\}} 4:\{y\} \xrightarrow{\{d\}} 5, l(\pi) = \{x^mcy^nd \mid n \geq 0, m \geq 0\}$}
...
Let $G = (N, \Sigma, P, S)$ be the input grammar, the input \simpleton{edge-labeled (-> labeled)} graph $D = (V, E, \Sigma_V, \Sigma_E, \lambda_V, \lambda_E)$ and language $L$ over alphabet $\Sigma$.
