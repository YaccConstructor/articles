...
\begin{frame}[fragile]
  \frametitle{A Bit More on Linear Algebra}
    ...
    \begin{itemize}
      ...
      \item \href{https://dl.acm.org/doi/abs/10.1145/3514221.3517869}{TCUDB: Accelerating Database with Tensor Processors} by Yu-Ching Hu % SIGMOD 2022
      \item \href{https://dl.acm.org/doi/abs/10.1145/3318464.3389747}{A Relational Matrix Algebra and its Implementation in a Column Store}  by Oksana Dolmatova %SIGMOD 2020
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
      ...
      \item Second one allows for fine-grained optimizations
    \end{itemize}
    }{6.6}
    \onslide<3>{
    \item Linear algebra
