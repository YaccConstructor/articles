...
By using induction we always work with subtrees that describes some part of word.
Graphical representation of the idea of the Chomsky induction fore case described above one can find in figure~\ref{fig:induction}.
