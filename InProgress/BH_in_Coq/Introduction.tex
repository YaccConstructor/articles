...
Intersection of some classes of languages is not generally decidable.
...
\item We generalize results of Gert Smolka: alphabets (nonterminals and terminals) in context-free grammar definition changed from Nat to generic and all relative stuff also modified to works with updated definition.
