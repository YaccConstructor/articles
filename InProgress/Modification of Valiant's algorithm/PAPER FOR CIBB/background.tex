...
Firstly, define multiplication of two submatrices of parsing table $T$.
...
Only the small number of first steps is shown, because later we point out at this version and our approach differences.
