...
Bioinformatics requires working with a large amount of data, so it is necessary to improve the existing parsing techniques. 
...
This paper presents a modification of the Valiant’s algorithm, which provides the possibility to divide the parsing table into successively computed layers of disjoint submatrices where each submatrix of the layer can be processed independently. 
