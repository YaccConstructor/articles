...
To apply parser-based solutions to such area as bioinformatics, one needs to improve parsing techniques ao that the processing of large amount of data were possible.
