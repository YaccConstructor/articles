...
This technique has been actively developed since 1972 (N.D.Jones, P.Sestoft, R.Gluck e.t.c.), but only in 2018 it has been successfully applied to optimize query execution procedures in relational database system PostgreSQL by E. Sharygin and coauthors (Sharygin Eugene et.al. 2018. Runtime Specialization of PostgreSQL Query Executor). 
