...
CFPQ (known as CFL-reachability problem in static code analysis) are actively studied in the recent years.
...
It is important in CFPQ to be able to restore paths of interest.
