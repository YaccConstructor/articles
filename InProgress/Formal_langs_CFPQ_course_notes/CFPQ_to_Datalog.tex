...
\textbf{NB!} В даталоге отсутствуют функциональные символы (но есть в реализациях), а отрицание ограничено.\\
...
$s(I, I).\\
s(I,J) \coloneq s(I, K-1),s(K, J).\\
s(I, J)\coloneq a(I, L),S(L,M),b(M,J).\\$
