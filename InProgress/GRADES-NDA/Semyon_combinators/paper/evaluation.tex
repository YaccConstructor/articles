...
Querying for ontologies is a well-known graph querying problem. We evaluate our library on some popular ontoloies which are presented as RDF files in the paper~\cite{CFGonRDF}. 
