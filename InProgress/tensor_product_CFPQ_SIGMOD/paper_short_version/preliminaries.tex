...
To introduce the \term{Language-Constraint Path Querying Problem}~\cite{!!!} over directed edge-labeled graphs we first give both language and grammar definitions.
...
This case is widespread~\cite{!!!} and well-studied.
