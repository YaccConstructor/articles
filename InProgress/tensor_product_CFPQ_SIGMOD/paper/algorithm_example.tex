   ...
   \begin{tikzpicture}[->,auto,node distance=0.5cm]
      ...
      \node[state] (q_6)  [right=of q_5] {$(2, 1)$};
       ...
       \path[->]
        ...
        ;
    \end{tikzpicture}
    \caption{The Kronecker product graph of RSM $R$ and the input graph $\mathcal{G}$, edges forming new paths are marked bold}
   ...
   \begin{tikzpicture}[->,auto,node distance=0.5cm]
      ...
      \node[state] (q_6)  [right=of q_5] {$(2, 1)$};
       ...
       \path[->]
        ...
        ;
    \end{tikzpicture}
    \caption{The Kronecker product graph of RSM $R$ and the updated graph $\mathcal{G}$, edges forming new paths are marked bold}
