   ...
   \begin{tikzpicture}[->,auto,node distance=0.5cm]
      ...
      \node[state] (q_6)  [right=of q_5] {$(2, 1)$};
       ...
       \path[->]
        ...
        (q_4) edge  node {} (q_1)
        (q_5) edge [bend left, below, very thick]  node {} (q_7)
        (q_6) edge   node {} (q_7)
        ;
    \end{tikzpicture}
   ...
   \begin{tikzpicture}[->,auto,node distance=0.5cm]
      ...
      \node[state] (q_6)  [right=of q_5] {$(2, 1)$};
       ...
       \path[->]
        ...
        (q_5) edge [bend left, below]  node {} (q_7)
        (q_6) edge[very thick]   node {} (q_7)
        ;
    \end{tikzpicture}
    \caption{The Kronecker product graph of RSM $R$ and the updated graph $\mathcal{G}$}
    ...
    \begin{tikzpicture}[shorten >=1pt,auto]
       ...
       \node[state] (q_1) [right=of q_0]       {$1$};
        ...
        (q_0) edge[bend left, above]   node {a} (q_1)
         (q_0) edge[red, very thick]   node {S} (q_1)
...
.4 $\cdots$.
.5 getPaths(0, 1, S) // \begin{minipage}[t]{4cm}An alternative way to get paths from 0 to 1 which leads to infinite set of paths \end{minipage}.
.10 return $r_\infty^{0 \leadsto 1}$ // \begin{minipage}[t]{4.5cm} An infinite set of path from 0 to 1 \end{minipage}.
.8 $\cdots$.
