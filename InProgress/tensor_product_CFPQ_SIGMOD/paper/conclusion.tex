...
Thus, the first task for the future is to find a truly sublinear algorithm for incremental transitive closure or, as a first step, to improve the logarithmic factor.
