...
\begin{itemize}
    ...
    \item The set of production rules $P^1$ is presented in the Figure~\ref{ProductionRulesQuery1}.
\end{itemize}
...
\begin{itemize}
    ...
    \item The set of production rules $P^2$ is presented in the Figure~\ref{ProductionRulesQuery2}.
\end{itemize}
