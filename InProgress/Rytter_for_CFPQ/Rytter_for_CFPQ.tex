...
%     (q_1) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_2)
%     (q_5) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_6)
%     (q_9) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_10)
%     (q_13) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_14)

%     (q_1) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_3)
%     (q_5) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_7)
%     (q_9) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_11)
%     (q_13) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_15)

%     (q_1) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_4)
%     (q_5) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_8)
%     (q_9) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_12)
%     (q_13) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_16)



%     (q_2) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_1)
%     (q_6) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_5)
%     (q_10) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_9)
%     (q_14) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_13)

%     (q_3) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_1)
%     (q_7) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_5)
%     (q_11) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_9)
%     (q_15) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_13)

%     (q_4) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_1)
%     (q_8) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_5)
%     (q_12) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_9)
%     (q_16) edge[bend left]  node {\tiny{$\{(B,S);(S_1,S)\}$}} (q_13)
