...
The !!! isto use probabilistic grammars.
...
For example, pseudoknots can not be expressed by context-free grammars, but can be expresed by using cinjunctive~\cite{KanchanDevi2017,zier2013rna,Okhotin:2001:CG:543313.543323} or multiple context-free~\cite{SEKI1991191}.
...
\end{verbatim}
\caption{Ci=ontext-free grammar for RNA secondary structure features extraction}
\label{fig:cfg-rna}
\end{figure}
...
Matrix-based approach can be generalized to conjunctive and even boolean grammars~\cite{OKHOTIN2014101}, as far as to multiple context-free grammars~\cite{!!!}, which can provide a base for more expressive features descriptions handling.
