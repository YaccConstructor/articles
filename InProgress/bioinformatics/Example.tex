...
Also one can increase (or decrease for some reason) the minimal geight of stem, or add pseudocnot 
description in the grammar.
...
Train network which can handle sequences, not parsing data.
