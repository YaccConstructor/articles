...
Matrix-based approach can be generalized to conjunctive and even boolean grammars~\cite{OKHOTIN2014101} which can provide a base for more expressive features descriptions handling.
