...
\node (q1) at  (1, 4.2) {$(S, i,  j)$}; 
\node (q1) at  (2.7, 1) {$...$}; 
\node (q1) at  (3.45, 0.5) {$(S, i,  j)$}; 
\node (q1) at  (2.05, 3.5) {$(S, k,  j)$}; 
\node (q1) at  (-0.2,3.5) {$(S_1, i,  k)$}; 
\node (q1) at  (2.55, 2.5) {$(S,l,j)$}; 
\node (q1) at  (0.3, 2.25) {$(S_1, k, l)$}; 
\node (q1) at  (3.1, 1.5) {$(S, m, j)$}; 
\node (q1) at  (0.75, 1.25) {$(S_1, l, m)$}; 
...
\node (q1) at  (2,-0.15) {$l$};
\node (q1) at  (3,-0.15) {$j$};
\node (q1) at  (2.3,-0.15) {$m$};


\end{tikzpicture}
\\
	\caption{Parse trees after applying Kleene star operation (left) and insersion of the language with a polynomial rational index (right).}
\label{closure}
\end{figure}
