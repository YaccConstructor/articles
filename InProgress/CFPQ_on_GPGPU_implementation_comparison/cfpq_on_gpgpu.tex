...
\title[Evaluation of the Matrix Multiplication Based CFPQ Algorithm]{Evaluation of the Matrix Multiplication Based Context-Free Path Querying Algorithm}
...
\begin{abstract}
Recently proposed matrix multiplication based algorithm for context-free path querying (CFPQ) evaluation offloads the most performance-critical parts onto boolean matrices multiplication (BMM). 
Thus it is possible to utilize modern parallel hardware and software to achieve high performance of CFPQ easily.
In this work, we provide results of empirical performance comparison of different implementations of this algorithm on both real data and synthetic data for the worst cases.
...
\keywords{Transitive closure, context-free path querying, graph databases, context-free grammar, GPGPU, matrix multiplication, boolean matrix}
