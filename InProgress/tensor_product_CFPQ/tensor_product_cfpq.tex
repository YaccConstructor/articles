...
\begin{document}
%
\title{Context-Free Path Querying by Using Kronecker Product\thanks{The research was supported by the Russian Science Foundation, grant \textnumero 18-11-00100}}
%
...
\input{introduction}
\input{recursive_state_machines}
\input{kronecker_cfpq}
\input{evaluation}
\input{conclusion}
