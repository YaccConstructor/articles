...
Then the lines \textbf{14--18} are executed. In that section, the algorithm adds non-terminals to the graph matrix $M_2^1$. Because this step is additive we are only interested in newly appeared values in matrix $C_3^1$ such as value $C_3^1[1,15]$ for which we get the follows.
\begin{itemize}
