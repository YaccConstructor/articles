...
The algorithm for CFG to RSM conversion is provided in~\cite{!!!}.
An example of RSM $R$ for the grammar $G$ with rule $S \to a S b \mid a b$ is provided in figure~\ref{example:automata}.
