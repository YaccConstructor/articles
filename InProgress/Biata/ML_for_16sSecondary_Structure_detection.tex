...
For network training we use dataset combined from two parts: positive examples are random parts of 16s sequences from Greengenes database, negative examples are random parts of full genes form NCBI database.%~\cite{NCBI}. 
