...
Libraries operate on the boolean semiring with values set \{\textit{true}, \textit{false}\} with \textit{false} as an identity element, '+' operation is defined as logical \textit{or} and '*' is defined as logical \textit{and}.
