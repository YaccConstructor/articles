...
\textit{clBool}\footnote{\cho{clBool project: \url{https://replace/me/with/actual/url}. Access date: 03.02.2021.}} and \textit{cuBool}\footnote{cuBool project: \url{https://github.com/JetBrains-Research/cuBool}. Access date: 03.02.2021.} respectively.
...
Libraries operate on the boolean semiring with values set \{\textit{true}, \textit{false}\} with \textit{false} as
