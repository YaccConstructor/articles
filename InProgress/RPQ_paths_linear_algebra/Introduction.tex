...
\begin{itemize}
	...
	\item Instantiation of the framework with specific semirings to solve distinct problems: Boolean semiring for reachability, and path semiring with index unary operators for all-simple-paths and all-trails and all-shortest-paths semantics.
