...
\begin{tikzpicture}[
  ...
  \node [anchor=north east, inner sep=1pt, font=\scriptsize] at ($(over.south east)+(-0.15cm,0)$) {Filtered by $I_{simple}$};

  \node (m_sum) [inner sep=1pt, below=0.0cm of La] {$\oplus$};
  \node (m_eqq) [inner sep=1pt, below=0.0cm of Lb] {$=$};
  ...
  \node [anchor=south west, inner sep=1pt, font=\scriptsize] at ($(Mres.south west)+(0,-0.27cm)$) {$P^F$:};
