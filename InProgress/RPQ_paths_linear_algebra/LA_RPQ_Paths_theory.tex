...
\begin{figure}
	\fbox{
		\begin{minipage}{\linewidth}
			\textbf{Input:} Semiring $\mathcal{S} = \langle D_{out}, D_{in_1}, \mathbb{B}, \oplus, \otimes, \mathbf{0} \rangle$, index unary operator $I^P$, 2-NFA $\mathcal{N} = \langle Q, \Sigma, \Delta, \lambda_\mathcal{N}, Q_S, Q_F \rangle$, graph $\mathcal{G}=\langle V, E, L, \lambda_\mathcal{G} \rangle$, source $v_s \in V$ \\
			...
			\begin{enumerate}
				...
				\item While $M \ne \mathbf{0}$:
				      \begin{itemize}
					      \item If $I^P$ defined: $M \gets I(M)$
