...
\begin{definition}[Simple path]
	A path $\pi = (e_1, e_2, \ldots, e_n)$ is simple if it contains no repeated vertices except possibly the first and last. Formally, $\forall 1 \leq i, j \leq n: v_i = u_j \Rightarrow j = i + 1$.
\end{definition}
