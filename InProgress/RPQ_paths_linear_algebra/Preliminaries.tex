...
Figure~\ref{fig:semantics-examples} presents examples of single source query results under different semantics on the same graph: \emph{all simple paths}, \emph{all trails}, and \emph{all shortest paths}.
