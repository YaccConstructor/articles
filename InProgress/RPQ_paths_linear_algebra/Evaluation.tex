...
The tail of queries that are challenging for MillenniumDB is thinner for LARPQ, as illustrated in Figure~\ref{fig:wikidata_trails_common}. In the common-trails setting, FalkorDB achieves the best total and mean times, while LARPQ achieves the best median time.
