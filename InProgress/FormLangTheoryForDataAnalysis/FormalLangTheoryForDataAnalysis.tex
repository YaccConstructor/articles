...
\renewcommand{\shortauthors}{S. Grigorev and !!!, et al.}
...
\begin{enumerate}
  ...
  \item Implementation of multiple-source linear-algebra-based RPQ algorithm.%, including different versions such as one-to-many and many-to-many.
