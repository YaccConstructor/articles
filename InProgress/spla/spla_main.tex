...
\begin{abstract}
    ...
    Preliminary evaluation shows that while further optimizations are required, the proposed solution demonstrates performance comparable with GraphBLAST on some tasks. Moreover, utilization of embedded GPU allows one to improve the performance of some graph analysis tasks in comparison with SuiteSparse:GrpaphBLAS on the same CPU.
\end{abstract}
