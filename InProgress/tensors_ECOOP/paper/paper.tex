...
\keywords{CFL-reachability, program analysis, linear algebra } %TODO mandatory; please add comma-separated list of keywords
...
\paragraph*{Representation the input as sets of Boolean adjacency matrices}

\paragraph*{Easy implementation of transitive closure}



\paragraph*{Custom semirings}
...
\paragraph*{Graph systems for interprocedural static code analysis}
\subsection{Linear algebra-based graph analysis tools}
