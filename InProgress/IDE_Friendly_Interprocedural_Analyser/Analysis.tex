...
To apply the framework, the first thing to do is to define the roles and representation of the graph and the path restrictions.
...
In order to keep the expressive power of the CFL-reachability approach but make the implementation easier, we propose to use pushdown automata instead of grammars which have equivalent power.
...
(TODO: AND BY THIS WE FOUND SOME ISSUE IN THE PROGRAM)
