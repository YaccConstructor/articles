...
One of the classical problems which require interprocedural analysis is taint tracking problem (e.g. described in \cite{TaintTrackingIntro} and \cite{TaintTrackingISO}).
The problem is that the input data can have an inappropriate format or contains an exploit such as SQL injection.
