...
This definition of conjunctive grammars uses the rewriting rules. Also, there are other definitions for the semantics of these grammars. For example, there is a definition using language equations with union, intersection and concatenation~\cite{okhotin2001conjunctive}.
