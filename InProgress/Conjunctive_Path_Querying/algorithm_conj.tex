...
\begin{itemize}
    ...
    \[
    \begin{array}{rccl}
    0: & S  \rightarrow & AB \ \& \ DC     \quad & 4:  C  \rightarrow  c \\  
    1: & A  \rightarrow & a \hfill               \quad & 5:  D  \rightarrow  AD \\ 
    2: & B  \rightarrow & BC \hfill               \quad & 6:  D  \rightarrow  b \\ 
    3: & B  \rightarrow & b  \hfill                    &                       \\
    \end{array}
    \]
...
Thus, the result of the Algorithm~\ref{alg:graphParse_conj} for the example query is the matrix $T_4 = T_3$. Now, after constructing the transitive closure, we can construct the over-approximations $R'_A$ of the conjunctive relations $R_A$. Approximations for each non-terminal of the grammar $G$:
    \begin{eqnarray}
    R'_S&=&\{(0,3),(0,4),(1,4)\},\\
    R'_{A}&=&\{(0,1),(1,5)\},\\
