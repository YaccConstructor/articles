...
\begin{tikzpicture}[>=Stealth, node distance=0.5cm]
    \begin{scope}[local bounding box=group1]
        ...
        \node (l) [below = of Add.left pax, draw, circle, fill=darkblue] {};
        \node (r) [below = of Add.right pax, draw, circle, fill=darkred,  ] {};
    ...
    \begin{scope}[shift={(group1.east)}, xshift=2.5cm]
        \matrix[row sep=1em]{
            \node (t) [draw, circle, fill=darkblue] {};  \\
            \node (p1) {$\phantom x$}; \\
            \node (b1) [draw, circle, fill=darkred] {}; \\};
            \inetwirecoords(t)(b1)
    \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}[>=Stealth, node distance=0.5cm]
    \begin{scope}[local bounding box=group1]
        \matrix[row sep=1em]{
            ...
            \node (la) [below = of Add.left pax, draw, circle, fill=darkred] {};
            \node (ra) [below = of Add.right pax, draw, circle, fill=darkblue] {};
            \node (sm) [above = of S.middle pax, draw, circle, fill=darkgreen] {};
    ...
    \begin{scope}[shift={(group1.east)}, xshift=2.5cm]
        ...
        \node (ap) [above = of Add.pal, draw, circle, fill=darkgreen] {};
        \node (la) [below = of Add.left pax, draw, circle, fill=darkred] {};
        \node (sp) [below = of S.pal, draw, circle, fill=darkblue] {};
