...
\textbf{Performance} analysis shows that in all cases (Figures~\ref{fig:coAuthors_execution_time}, \ref{fig:bone_and_usroads_execution_time}, \ref{fig:andrews_execution_time}, \ref{fig:bfs_treferthen_execution_time}, \ref{fig:sssp_treferthen_execution_time}, \ref{fig:bfs_gr_3_30_execution_time}, \ref{fig:sssp_gr_3_30_execution_time}), interaction-net-based implementations are several orders of magnitude slower (up to $10^5$) than both NetworkX and LAGraph. 
...
Even on small graphs, Vine is slower than Inpla by up to an order of magnitude, as shown in Figures~\ref{fig:bfs_treferthen_execution_time}, \ref{fig:sssp_treferthen_execution_time}, and \ref{fig:bfs_gr_3_30_execution_time}.
...
\textbf{Scaling analysis} reveals that, in almost all cases (see Figures~\ref{fig:coAuthors_scaling}, \ref{fig:bone_and_usroads_scaling}, \ref{fig:andrews_scaling}, \ref{fig:bfs_treferthen_scaling}, and \ref{fig:tc_gr_3_30_scaling}), the scaling behavior of all interaction-net-based implementations is straightforward: execution time decreases as the number of threads increases.
