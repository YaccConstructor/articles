...
\begin{enumerate}
    ...
    \item \textbf{Load balancing and scaling.} The current configuration of Inpla scales poorly on small graphs but well on large ones. Vine generally scales better than Inpla, and scaling remains sensitive to matrix reordering. Can the load balancing strategy be improved to address these issues? 
