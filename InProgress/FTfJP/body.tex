...
It is known that shuffled CFL is not closed under intersection with regular languages, but decidability of intersection emptiness is looks an open question.
