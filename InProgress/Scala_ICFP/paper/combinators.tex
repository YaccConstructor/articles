...
Applying this transformation lets us use previously implemented action executor to get a set of query results.
...
Our solution is based on breadth first search that yields an unambiguous SPPF immediately after it was found.
