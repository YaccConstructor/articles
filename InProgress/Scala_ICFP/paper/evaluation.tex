...
The performance results are shown in the table~\ref{table:rdfs} where $\#results$ is a number of pairs of the nodes between which at least one S-path exists. 
...
60000 nodes and more than 100000 edges.
