...
In order to examine the applicability of our library for the real data processing we evaluate queries presented in the section~\ref{sec:examples} on the classical movie database which contains more than 60000 nodes and !!! edges. 
...
Our library implements a general parsing algorithm which supports abitrary context-free queries. 
