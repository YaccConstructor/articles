...
\begin{itemize}
  ...
  \item We compare our implementation with other implementations of the linear algebra-based CFPQ algorithms
\end{itemize}
}
...
\headerbox {CFPQ with All-Path Semantics}
...
\headerbox{CFPQ Evaluation with Relational, Single-Path and All-Path Query Semantics}{name=scaling,span=12,column=0,row=2,below=rdfs}{
\vspace{0.05cm}
%\begin{table}[h]
%\rowcolors{1}{}{red}
%\begin{center}
...
\includegraphics[width=2.5cm]{qr-research-jetbra.pdf}
\vspace{0.7cm}
\end{minipage}
%\vspace{1cm}
{\scriptsize
