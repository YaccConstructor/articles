...
\thanks{\cho{Identify applicable funding agency here. If none, delete this.}}
}
...
Our evaluation shows that operations specialized for Boolean matrices can be up to 5 times faster and consume up to 4 times less memory than generic operations from modern libraries.
