...
\begin{frame}[fragile] \frametitle{Formal Language Constrained Path Querying}
  ...
  \begin{itemize}
        ...
        \item Th expressiveness of constraints is related to \textbf{formal languages classes}
  \end{itemize}
  %\pause
...
\begin{frame}[fragile] \frametitle{Proposed Solution}
  \begin{itemize}
      \item \textbf{Multiple-Source CFPQ} to process only the relevant subset of a graph
      \pause
...
\begin{itemize}
  ...
  \item Graphs are stored in RedisGraph with our extensions
