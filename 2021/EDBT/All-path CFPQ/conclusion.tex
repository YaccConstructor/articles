...
In this paper, we propose a new modification of Azimov's matrix-based CFPQ algorithm for all-path query semantics. We implement our algorithm using GraphBLAS API and provide a comparison of the most performant linear algebra-based algorithms. %We show that the proposed algorithm is performant enough for real-world data analysis and comparable with other most performant CFPQ implementations.
