...
the regular approximation. Now we have to prove, that, first, SPPF contains only correct trees, 
...
for RNGLR-algorithm, except the following moment. RNGLR constructs GSS layer-by-layer: it is guaranteed, that $\forall j \in [0..i-1]$ 
