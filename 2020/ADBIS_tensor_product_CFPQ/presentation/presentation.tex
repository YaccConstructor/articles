...
\begin{frame}[fragile] \frametitle{CFPQ Algorithm Iteration 1: Product Automaton}	
...
\begin{frame}[fragile] \frametitle{CFPQ Algorithm Iteration 2: Product Automaton}	
...
\begin{subfigure}{.38\textwidth}
	\begin{center}
		\[
		\begin{array}{rcccccl}
		\underline{\textbf{0}},0 & \xrightarrow{\textbf{a}} & 1,1 & \xrightarrow{\textbf{S}} & 3,2 & \xrightarrow{\textbf{b}} & \underline{\textbf{2}},3 \\
		1,0 & \xrightarrow{\text{a}} & 2,1 & \xrightarrow{\text{b}} &	3,3 & &\\
		2,0 & \xrightarrow{\text{a}} & 0,1 & & & &\\
		2,2 & \xrightarrow{\text{b}} & 3,3 & & & &\\
		3,1 & \xrightarrow{\text{b}} & 2,3 & & & &\\
		\end{array}
...
\begin{subfigure}{.48\textwidth}
	\begin{center}
		...
		(q_2) edge[bend left, above]  node {b} (q_3)
		(q_3) edge[bend left, below]  node {b} (q_2)
		(q_0) edge[bend right = 60, below]  node {\textbf{S}} (q_2);
		\end{tikzpicture}
		%\caption{The updated input graph $\mathcal{G}$ using rule $S \to a b$}
	\end{center}
\end{subfigure}
