	...
	\begin{minipage}[t]{0.5\textwidth}
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item $\textbf{RG\_SPARSE}_{\textit{rel}}$ --- relational semantics, uses low-latency on-chip shared memory for the hash table of each row of the result matrix
				
				\item $\textbf{RG\_SPARSE}_{\textit{path}}$ --- single-path semantics, operating over PathIndex
			\end{itemize}
		\end{itemize}
	\end{minipage}
}
...
\begin{tabular}{| l | c | c | r  r | r  r | r  r | r  r | r  r |}
	...
	\hline
	\hline
	%core           & 1,323		& 8,684              & 0.004 & 0.3  & 0.022 & 2.0   & 0.010  & 0.1      & 0.002 & 0.3  & 0.016 & 0.1  \\
...
\end{tabular}
%\end{center}
\includegraphics[width=0.4\textwidth]{plots/G1_go.pdf}
\begin{minipage}[t]{0.5\textwidth}
	\vspace{0.05cm}
	\begin{itemize}
