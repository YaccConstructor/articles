...
All two curves can be fit with polinomial function of degree 4. 
...
Also we present SPPF size in terms of nodes~\ref{pic:SPPFSize} for both $G_0$ and $G_2$ grammars. All two curves are cubic. 
...
plot 'perf/2' using 1:6 with lines ls 3 ti '$G_2$',\
     'perf/2' using 1:7 with lines ls 4 ti '$G_0$',\
 \end{gnuplot}
