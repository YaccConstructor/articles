...
set xlabel '$x$-label'
set ylabel '$y$-label
plot 'perf/2' using 1:2 with lines ls 2 ti '$Bad$',\
     'perf/2' using 1:3 with lines ls 3 ti '$Unamb$',\
...
set xlabel '$x$-label'
set ylabel '$y$-label
plot 'perf/2' using 1:5 with lines ls 2 ti '$Bad$',\
     'perf/2' using 1:6 with lines ls 3 ti '$Unamb$',\
...
plot 'perf/3' using 1:2 with lines ls 2 ti '$Unamb$',\
     'perf/4' using 1:2 with lines ls 2 ti '$bad$',\
