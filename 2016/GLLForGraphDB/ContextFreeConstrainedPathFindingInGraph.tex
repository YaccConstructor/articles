...
Shared Packed Parse Forest (SPPF) is a spectial structure for compact derivation forest representation. GLL use binarized form of SPPF proposed~\cite{brnglr} which allow to achive worst-case cubic space complexity.
