...
Use SPPF~\cite{gllParsingTree} for results representation
...
We are working on GPGPU Valiant~\cite{valiantParsingWithMatrixMultiplication} Okhotin~\cite{okhotin2014parsingWithMatrixMultiplication}
