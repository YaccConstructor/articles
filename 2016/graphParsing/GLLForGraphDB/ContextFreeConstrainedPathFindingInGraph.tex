...
creating structural representation of query result which is practical for 
...
These algorithms have nonlinear time complexity for unambiguous grammars ($O(n^3)$ and $O(n^2)$ respectively), but there are such parsing algorithms as GLR and GLL, which have cubic worst-case complexity and linear for unambiguous grammars.  
