...
One of specific problems on graph DB is a path querying with constrains 
formulated in terms of formal grammars. There is a number of solutions, but
...
Further, if we want to check a correctness of dynamically generated strings, then we should check that all generated strings (all paths from start states to final states in the given automata) are correct with respect to some context-free grammar. 
