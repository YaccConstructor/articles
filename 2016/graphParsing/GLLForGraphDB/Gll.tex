...
Control functions of table based GLL are presented in listing~\ref{mainTblFunctions}. All other functions are the same as in original algorithm and their description can be found in original article~\cite{GLL} or in Appendix~\ref{GLLCode}.
