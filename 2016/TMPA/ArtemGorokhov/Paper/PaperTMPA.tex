...
There is a wide range of parsing techniques and algorithms (CYK, LR(k), LALR(k), LL(k), etc) and parser generation tools, which based on it. 
Some of techniques are adoptThere are algorithms for parsing ECFG without transformations, based on different classical algorithms: 
...
The LL family of parsing algorithms is more intuitive than LR and can provide better error diagnostic.
