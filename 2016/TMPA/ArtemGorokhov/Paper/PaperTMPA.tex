...
Extended BNF is a useful format of grammar specification.

But BNF required for classical parsing algorithms. ELL, ELR~\cite{ELRR,ELALR,ELRParsing,ECFGparsing,AttributedELL,ELLParser,ELL,ECFG} and other can process EBNF but what about ambiguities in grammars. It is aproblem.

Generalized LL is good chice for parsing. Let's adopt it!
...
%Purdom, P.W., Brown, C.A.: Parsing extended LR(k) grammars (1981)

%Morimoto, S.I., Sassa, M.: Yet another generation of LALR parsers for regular right part grammars (2001)

%Breveglieri, L., Crespi Reghizzi, S., Morzenti,A.: Shift-reduce parsers for transition networks (2014)
