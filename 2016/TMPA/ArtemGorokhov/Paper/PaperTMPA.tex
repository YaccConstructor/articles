...
\begin{figure}[H]
    ...
    \subfloat[RA $R_1$ for $G_1$.]{
        \includegraphics[scale=.5]{pictures/automatonForSPPFG1.pdf}
        \label{fig:automatonForG1}
    }
    ~
    \subfloat[SPPF for $R_1$ and input $ aabk $.]{
        \includegraphics[scale=.5]{pictures/SPPFforG1.pdf}
        \label{fig:SPPFForG1}
    }
...
\begin{figure}[H]
    ...
    \subfloat[RA for grammar $G_2$.]{
        \includegraphics[height=0.36\textwidth]{pictures/automatonForG2.pdf}
