...
Symbol in constructed SPPF node become the value of the argument.
\input{getNodes.tex}
\input{getNodeP.tex}

\section{Evaluation}

We have implemented parser generator for purposed algorithm, and
...
Parser for RA creates less GSS edges because the tails of alternatives in producions
are just the only path in RA. This fact leads to decrease of SPPF nodes and GSS edges.
