...
This approach is named \emph{context-free path querying} and can be applied to some problems in bioinformatics: metagenomic assemblies analysis, graph data base querying.
...
\headerbox{Acknowledgments}{name=ack,column=2,span=2,below=app2}{
