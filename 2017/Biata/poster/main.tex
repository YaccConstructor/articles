...
\headerbox{Context-free path querying}{name=CFParsing,span=2,column=0,row=1,below=future}{
...
\headerbox{References}{name=references,column=2,span=2,below=eval1}{
...
\headerbox{Acknowledgments}{name=ack,column=0,span=2,below=CFParsing}{
