...
\headerbox{Context-free path querying}{name=receiver,span=2,column=0,row=1,below=future}{
...
\headerbox{Acknowledgments}{name=ack,column=2,span=2,below=references}{
