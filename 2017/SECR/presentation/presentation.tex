...
\begin{itemize} 
\item Основан на обобщённом LL (GLL)
\item Не нужна НФХ
\item Произвольные КС граммтики
\item SPPF
\end{itemize}
...
\cline{3-6}
& & \shortstack{time \\ (ms)} & \#results & \shortstack{time \\ (ms)} & \#results \\
\hline 
\hline
skos        & 252 & 10 & 810 & 1 & 1 \\
...
\shortstack{biomedical- \\ measure-primitive} & 459 & 261 & 15156 & 45 & 2871 \\
