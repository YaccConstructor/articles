...
The fact that one language can be described with multiple grammars allows to add checkpoints: additional nonterminals can mark required subpaths \empth{(or substrings --- I am not sure which one suites better)}.
