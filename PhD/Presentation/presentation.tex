...
\begin{frame}
    ...
    \begin{enumerate}
        \item Разработан алгоритм синтаксического анализа динамически формируемых программ, гарантирующий конечность представления леса вывода
        \begin{itemize}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Может быть получена различными способами
        \item Может быть разной точности
        \item JSA, Alvor и т.д. 
        ...
        \begin{itemize}
          \item Учёт строковых функций (replace и т.д.)
