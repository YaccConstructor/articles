...
%        \item В существующих подходах не строится структурноге представления динамически формируемых программ
...
\begin{frame}
    ...
    \begin{itemize}
        \item Целью данной работы является создание подхода к \underline{статическому} анализу \underline{динамически формируемых} программ, 
...
\begin{frame}[t]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
          \item Конфликт точности или производительности
        ...
        \begin{itemize}
          \item В настоящее время не известно, какие задачи можно решать над полученным представлением леса разбора
        \end{itemize}
    \end{itemize}
\end{frame}
...
%          \item CEE-SECR (2012, 2013, 2014)
%          \begin{itemize}
%             \item Премия Бертрана Мейера за лучшую исследовательскую работу в области программной инженерии (2014)
%          \end{itemize} 
%          \item Parsing@SLE-2013
%          \item Семинар по наукоёмкому программному обеспесчению при PSI-2014
%          \item Научный семинар по программной инженерии (2013, 2015, СПбПГУ)
