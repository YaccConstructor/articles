...
Current implementation utilizes GPGPU and shouldbe optimized in future.
};
...
{
\textbf{Vectors}\\
Line-by-line compressed matrix representation: sequence of 32 cells (bits) is compressed to unsigned integer. Top right triangle of matrix is always empty, so can be ignored.
