...
\filltitle{ru}{
    ...
    reviewerPosition   = {преподаватель, научный координатор кафедры информатики Академиии Або и Центра Компьютерных Наук TUCS},
    reviewer           = {Бараш М.\,Л.},
...
\filltitle{en}{
    ...
    reviewerPosition   = {University Teacher, Scientific Coordinator, Department of Computer Science, \r{A}bo Akademi University, and Turku Centre for Computer Science TUCS},
