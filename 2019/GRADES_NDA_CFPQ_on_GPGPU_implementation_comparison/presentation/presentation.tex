...
\begin{frame}[fragile] \frametitle{Questions for Evaluation}
  \begin{itemize}
    ...
    \pause
    \item Can we achieve a high-performance solution with high-level languages such as Python?
    \pause
    \item Can we gain more performance improvement by using sparse matrix representation for CFPQ?
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile] \frametitle{Evaluation: Full}
\begin{center}
  {\tiny
  \rowcolors{1}{}{lightgray}
