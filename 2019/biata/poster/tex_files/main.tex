...
%   INTRODUCTION
%----------------------------------------------------------------------------------------
\headerbox {Motivation}{name=introduction,column=0,row=0, span=4}{
...
\headerbox {Results}{name=results, column=2, row=2, span=2, below=introduction}{
...
We use sequences from databases~\cite{trnadb1, trnadb2}.
...
{
  \textbf{Matrices}\\
Parsing result for sequence $w$ and nonterminal $N$ is an upper-triangular boolean matrix $M_N$, where $M_N [i,j] = 1$, iff the substring $w[i,j-1]$ is derivable from $N$.
};
...
\textbf{Neural Networks}\\
 \vspace{0.2cm}
\includegraphics[width=9.5cm]{figures/nn_arch.png}
...
{name=app1,column=0,span=1, below=solution}
{
\begin{itemize}[noitemsep,nolistsep]  
{\setlength\itemindent{-10pt} \item Chimeric sequences filtration}
{\setlength\itemindent{-10pt} \item Secondary structure prediction}
{\setlength\itemindent{-10pt} \item Proteins functions prediction}
\end{itemize}
}
...
\headerbox {Acknowledgments}{name=ack,column=1,span=1,below=solution}{
