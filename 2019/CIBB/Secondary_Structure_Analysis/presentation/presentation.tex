...
\vspace{-0.25cm}
  ...
  \onslide<3>{\tikz[overlay,remember picture]{\draw[draw=red,thick,double,fill opacity=0.2, rounded corners] ($ (zzz) + (3.99,7.41)$) rectangle ($ (zzz) + (6.84,6.31)$);}}
...
\pause
\onslide<2>{\tikz[overlay,remember picture]{\draw[draw=red,thick,double,fill opacity=0.2] ($ (zzz) + (0.57,8.1)$) rectangle ($ (zzz) + (4.27,0.84)$);}}
...
\onslide<5>{\tikz[overlay,remember picture]{\draw[draw=red,thick,double,fill opacity=0.2] ($ (zzz) + (0.57,8.1)$) rectangle ($ (zzz) + (6.95,0.84)$);}}
