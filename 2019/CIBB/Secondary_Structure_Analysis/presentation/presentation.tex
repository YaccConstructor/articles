...
\vspace{-0.2cm}
  ...
  Parsing result for a sequence $\omega$ is a boolean matrix~$M$, where $ M[i,j] = 1 $ $\iff \text{\ttfamily{s1}} \xrightarrow{*}{} \omega[i,j]$.
  };
...
\vspace{-0.5cm}
  ...
  \pause
  \onslide<2>{\tikz[overlay,remember picture]{\draw[draw=red,thick,double,fill opacity=0.2, rounded corners] ($ (zzz) + (0.01,8.20)$) rectangle ($ (zzz) + (3.35,5.495)$);}}

  \onslide<3>{\tikz[overlay,remember picture]{\draw[draw=red,thick,double,fill opacity=0.2, rounded corners] ($ (zzz) + (3.99,7.41)$) rectangle ($ (zzz) + (6.87,6.31)$);}}

  \onslide<4>{\tikz[overlay,remember picture]{\draw[draw=red,thick,double,fill opacity=0.2, rounded corners] ($ (zzz) + (7.3,8.3)$) rectangle ($ (zzz) + (12.15,5.42)$);}}

  \onslide<5>{\tikz[overlay,remember picture]{\draw[draw=red,thick,double,fill opacity=0.2, rounded corners] ($ (zzz) + (7.3,4.68)$) rectangle ($ (zzz) + (12.15,1.03)$);}}

  \onslide<6>{\tikz[overlay,remember picture]{\draw[draw=red,thick,double,fill opacity=0.2, rounded corners] ($ (zzz) + (1.93,5.01)$) rectangle ($ (zzz) + (6.75,0.35)$);}}
...
\end{array} \right)\]}
  ...
  Parsing result for sequence $\omega$ is a boolean matrix~$M$, where $ M[i,j] = 1 \iff \text{\ttfamily{s1}} \xrightarrow{*}{} \omega[i,j]$.
  };
