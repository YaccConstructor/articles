...
\begin{frame}[fragile]
  \frametitle{Эксперименты с отимизациями}
  \includegraphics[width=0.49\textwidth]{pictures/time_graph_fpga_1024.png}
  \includegraphics[width=0.49\textwidth]{pictures/mem_graph_rtlsim_n128_TS4_WPT4_WID4_t16_w8_c2.png}
\end{frame}
