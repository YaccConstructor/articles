...
\category{D.2.7}{Software Engineering}{Distribution, Maintenance, and Enhancement}[Restructuring, and reengineering]
...
\terms{Algorithms, approximation}

\keywords{String-embedded language, integrated development environment, IDE, approximation, control flow graph, CFG, static analysis}

\input{02_Introduction.tex}
\input{03_Overview.tex}
\input{04_Platform.tex}
\input{05_Using_Platform.tex}
\newpage
